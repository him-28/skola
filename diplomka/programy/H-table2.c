...
int main(int argc, char *argv[]){
	...
	struct {
		...
		{"alphasp3CH3af", "", 1, "$\\alpha_\\mathrm{sp3CH3a}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp3CH3af", "", 1, "$\\nu_\\mathrm{sp3CH3a}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"alphasp3CH3sf", "", 1, "$\\alpha_\\mathrm{sp3CH3s}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp3CH3sf", "", 1, "$\\nu_\\mathrm{sp3CH3s}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"betasp3CH3sf", "", 0, "$\\beta_\\mathrm{sp3CH3}$\\,[10cm$^{-1}$]", "%.1f", 1e-1},
		{"alphasp3CH3sbf", "", 1, "$\\alpha_\\mathrm{sp3CH3bs}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp3CH3sbf", "", 1, "$\\nu_\\mathrm{sp3CH3bs}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"betasp3CH3sbf", "", 0, "$\\beta_\\mathrm{sp3CH3bs}$\\,[10cm$^{-1}$]", "%.1f", 1e-1},
		{"alphasp3CH2af", "", 1, "$\\alpha_\\mathrm{sp3CH2a}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp3CH2af", "", 1, "$\\nu_\\mathrm{sp3CH2a}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"alphasp3CH2sf", "", 1, "$\\alpha_\\mathrm{sp3CH2s}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp3CH2sf", "", 1, "$\\nu_\\mathrm{sp3CH2s}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"betasp3CH2sf", "", 0, "$\\beta_\\mathrm{sp3CH2}$\\,[10cm$^{-1}$]", "%.1f", 1e-1},
		{"alphasp3CHf", "", 1, "$\\alpha_\\mathrm{sp3CH}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp3CHf", "", 1, "$\\nu_\\mathrm{sp3CH}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"betasp3CHf", "", 0, "$\\beta_\\mathrm{sp3CH}$\\,[10cm$^{-1}$]", "%.1f", 1e-1},
		{"alphasp2CH2af", "", 1, "$\\alpha_\\mathrm{sp2CH2a}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp2CH2af", "", 1, "$\\nu_\\mathrm{sp2CH2a}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"alphasp2CH2sf", "", 1, "$\\alpha_\\mathrm{sp2CH2s}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp2CH2sf", "", 1, "$\\nu_\\mathrm{sp2CH2s}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"betasp2CH2sf", "", 0, "$\\beta_\\mathrm{sp2CH2}$\\,[10cm$^{-1}$]", "%.1f", 1e-1},
		{"alphasp2CHf", "", 1, "$\\alpha_\\mathrm{sp2CH}[10^{-3}]^\\ast$", "%.2f", 1e3},
		{"nusp2CHf", "", 1, "$\\nu_\\mathrm{sp2CH}$\\,[cm$^{-1}$]^\\dagger", "%.0f", 1.0},
		{"betasp2CHf", "", 0, "$\\beta_\\mathrm{sp2CH}$\\,[10cm$^{-1}$]", "%.1f", 1e-1},
