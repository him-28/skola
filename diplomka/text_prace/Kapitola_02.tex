...
V této práci byly DLC vzorky modelovány jako multivrstva: systém vrstva -- přechodová vrstva -- substrát -- zadní vrstva (obrázek \ref{}). Pro modelování dielektrické funkce vrstvy byl použit model PJDOS-DLC, pro modelování přechodové vrstvy byl použit model PJDOS, pro křemíkový substrát byl použit model PJDOS c-Si a pro modelování zadní vrstvy byly využity tabulkové hodnoty SiO$_2$.

\begin{figure}[h]
\centering
\includegraphics[width=12cm]{grafika/layerscheme.pdf}
\caption{layerscheme}
\label{Schéma multivrstevnatého systému, s použitými modely pro jednotlivé části}
\end{figure} 
