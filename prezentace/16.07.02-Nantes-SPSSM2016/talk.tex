...
\begin{frame}
   ...
   \begin{columns}
      ...
      \begin{column}{0.5\textwidth}
         ...
         \vspace{0.5cm}
         \only<3>{
            \includegraphics[width=0.5\linewidth]{figures/spaghettiOSi.pdf}
            \includegraphics[width=0.47\linewidth]{figures/spaghettinotOSi.pdf}
         }
      \end{column}
   \end{columns}
\end{frame}
      ...
      \begin{column}{0.5\textwidth}
         \only<3>{
            \begin{itemize}
               ...
               \item roughness (Rayley-Rice theory) inhomogeneity included in the model
...
\frametitle{Refractive index}
   \vspace{-0.3cm}
   \begin{center}
      \includegraphics[width=0.45\linewidth]{figures/SiTiO2-n.pdf}
   \end{center}
