...
\author[Pavel Ondračka]
       {\underline{Pavel Ondračka}\inst{1,2} \and David Holec\inst{3} \and Stéphane Elisabeth\inst{4} \and Eva Kedroňová\inst{1,2} \and Marek Eliáš\inst{1,2} \and David Nečas\inst{1} \and Antoine Goullet\inst{4} \and Mireille Richard\inst{4} \and Agnes Granier\inst{4} \and Lenka Zajíčková\inst{1,2}}
...
\begin{frame}
   ...
   \begin{columns}
      \begin{column}{0.8\textwidth}
         \begin{itemize}
            \item Density Functional Theory (Kohn, Hohenberg, Sham)
...
\begin{frame}
   ...
   \begin{itemize}
      ...
      \item Band gap increases slightly up to $x = 0.5$ then goes up sharply to values of SiO$_2$
      \item Refractive index changes linearly 
      \item When doping Si into TiO$_2$, Si-induced localized oxygen states appear near edges of valence band, special treatment is needed to get band gap comparable with experiment
   \end{itemize}
